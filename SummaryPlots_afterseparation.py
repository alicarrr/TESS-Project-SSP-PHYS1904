...
# Read csv
data = pd.read_csv("exoplanet_cleaned_big.csv")
...
plt.colorbar(sc, label='Stellar Magnitude')
ax2.set_xlim([0.0049, 0.05])
# ax2.set_ylim([0.2, 1.8])
ax2.set_xlabel('Depth 20s (Fractional Flux)') 
ax2.set_ylabel('Ratio of Depths (120s/20s)')
ax2.grid()
ax2.legend()
...
ax3.set_ylabel('Ratio of Depths (120s/20s)')
ax3.grid()
ax3.legend()


fig1.savefig('p4_magnitude_vs_ratio_after separation.png')
fig1.savefig('p4_magnitude_vs_ratio_after separation.pdf')


fig2.savefig('p5_ratio_vs_depth_after separation.png')
fig2.savefig('p5_ratio_vs_depth_after separation.pdf')

fig3.savefig('p6_depth_vs_depth_after separation.png')
fig3.savefig('p6_depth_vs_depth_after separation.pdf')
